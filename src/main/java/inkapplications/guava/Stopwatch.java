 ...
 * the License.
 *
 * This code has been modified from the original source in the following ways:
 *  - Removed dependency on `checkNotNull`, and `assertState` methods by throwing
 *    IllegalStateExceptions instead with the same message.
 *  - Removed Guava specific annotations
 *  - Changed package name to eliminate package conflicts.
 *  - Inlined methods from Guava's Platform.java
 */

package inkapplications.guava;
